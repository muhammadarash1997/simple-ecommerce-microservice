...
type Service interface {
	...
	UpdateQuantityByCartUUID(id string, quantity uint) error
...
func (this *service) UpdateQuantityByCartUUID(id string, quantity uint) error {
	err := this.cartRepository.UpdateQuantity(id, quantity)
	if err != nil {
		return err
	}
